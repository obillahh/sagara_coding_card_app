...
class CardImplRepository extends CardRepository {
                    ...
                    attributes: AvatarCardDataAttributesEntity(
                      ...
                      formats: AvatarCardDataAttributeFormatsEntity(
                        small: FormatDataEntity(
                          ext: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.ext ??
                              '',
                          url: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.url ??
                              '',
                          hash: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.hash ??
                              '',
                          mime: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.mime ??
                              '',
                          name: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.name ??
                              '',
                          path: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.path ??
                              '',
                          size: e.attributes?.avatarCard?.data?.attributes?.formats?.small
                                  ?.size ??
                              0,
                          width: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.small?.width ??
                              0,
                          height: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.small?.height ??
                              0,
                        ),
                        thumbnail: FormatDataEntity(
                          ext: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.ext ??
                              '',
                          url: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.url ??
                              '',
                          hash: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.hash ??
                              '',
                          mime: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.mime ??
                              '',
                          name: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.name ??
                              '',
                          path: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.path ??
                              '',
                          size: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.size ??
                              0,
                          width: e.attributes?.avatarCard?.data?.attributes?.formats
                                  ?.thumbnail?.width ??
                      ...
                      previewUrl:
                          e.attributes?.avatarCard?.data?.attributes?.previewUrl ?? '',
                      provider:
                          e.attributes?.avatarCard?.data?.attributes?.provider ?? '',
                      providerMetadata:
                          e.attributes?.avatarCard?.data?.attributes?.providerMetadata ??
                              '',
                      createdAt: e.attributes?.avatarCard?.data?.attributes?.createdAt ??
                          DateTime.now(),
                      updatedAt: e.attributes?.avatarCard?.data?.attributes?.updatedAt ??
                          DateTime.now(),
                    ),
                  ),
                ),
  ...
  Future<CardIdResponseDataEntity?> getCardById(int id) async {
    final response = await remoteDataSource.getCardById(id);
    if (response.data == null) {
      return null;
    }
    final data = CardIdResponseDataEntity(
      ...
      attributes: CardIdDataAttributesEntity(
        ...
        avatarCard: AvatarCardIdResponseEntity(
          data: AvatarCardIdDataEntity(
            ...
            attributes: AvatarCardIdAttributesEntity(
              ...
              alternativeText: response
                      .data?.attributes?.avatarCard?.data?.attributes?.alternativeText ??
                  '',
              caption:
                  response.data?.attributes?.avatarCard?.data?.attributes?.caption ?? '',
              width: response.data?.attributes?.avatarCard?.data?.attributes?.width ?? 0,
              height:
                  response.data?.attributes?.avatarCard?.data?.attributes?.height ?? 0,
              formats: FormatsIdEntity(
                small: FormatIdDataEntity(
                  ext: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.ext ??
                      '',
                  url: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.url ??
                      '',
                  hash: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.hash ??
                      '',
                  mime: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.mime ??
                      '',
                  name: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.name ??
                      '',
                  path: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.path ??
                      '',
                  size: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.size ??
                      0,
                  width: response.data?.attributes?.avatarCard?.data?.attributes?.formats
                          ?.small?.width ??
                      0,
                  ...
                  providerMetadata: ProviderMetadataEntity(
                    publicId: response.data?.attributes?.avatarCard?.data?.attributes
                            ?.formats?.small?.providerMetadata?.publicId ??
                        '',
                    resourceType: response.data?.attributes?.avatarCard?.data?.attributes
                            ?.formats?.small?.providerMetadata?.resourceType ??
                        '',
                  ),
                ),
                thumbnail: FormatIdDataEntity(
                  ...
                  providerMetadata: ProviderMetadataEntity(
                    publicId: response.data?.attributes?.avatarCard?.data?.attributes
                            ?.formats?.thumbnail?.providerMetadata?.publicId ??
                        '',
                    resourceType: response.data?.attributes?.avatarCard?.data?.attributes
                            ?.formats?.thumbnail?.providerMetadata?.resourceType ??
                        '',
                  ),
                ),
              ),
              ...
              previewUrl:
                  response.data?.attributes?.avatarCard?.data?.attributes?.previewUrl ??
                      '',
              provider:
                  response.data?.attributes?.avatarCard?.data?.attributes?.provider ?? '',
              providerMetadata: ProviderMetadataEntity(
                publicId: response.data?.attributes?.avatarCard?.data?.attributes
                        ?.providerMetadata?.publicId ??
                    '',
                resourceType: response.data?.attributes?.avatarCard?.data?.attributes
              ...
              createdAt:
                  response.data?.attributes?.avatarCard?.data?.attributes?.createdAt ??
                      DateTime.now(),
              updatedAt:
                  response.data?.attributes?.avatarCard?.data?.attributes?.updatedAt ??
                      DateTime.now(),
            ),
          ),
        ),
        quizzes: QuizCardResponseEntity(
          data:
              List<QuizCardDataModel>.from(response.data?.attributes?.quizzes?.data ?? [])
                  .map(
