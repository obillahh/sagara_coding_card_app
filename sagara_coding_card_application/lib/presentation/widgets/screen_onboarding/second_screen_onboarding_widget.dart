...
class SecondScreenOnboardingWidget extends StatelessWidget {
  final PageController pageController;
  const SecondScreenOnboardingWidget({super.key, required this.pageController});
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Image.asset(
                AssetsConstant.exploreOnboarding,
                width: 280.w,
              ),
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      'Dive into the world of coding with interactive challenges. Test your skills and learn as you play',
