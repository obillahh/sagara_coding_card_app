class CardResponseEntity {
    final List<CardDataEntity> data;
    ...
    factory CardResponseEntity.fromJson(Map<String, dynamic> json) => CardResponseEntity(
        data: List<CardDataEntity>.from(json["data"].map((x) => CardDataEntity.fromJson(x))),
...
class CardDataEntity {
    ...
    factory CardDataEntity.fromJson(Map<String, dynamic> json) => CardDataEntity(
        id: json["id"],
...
class CardDataAttributesEntity {
    ...
    factory CardDataAttributesEntity.fromJson(Map<String, dynamic> json) => CardDataAttributesEntity(
        name: json["name"],
        role: json["role"],
...
class AvatarCardEntity {
    ...
    factory AvatarCardEntity.fromJson(Map<String, dynamic> json) => AvatarCardEntity(
...
class AvatarCardDataEntity {
    ...
    factory AvatarCardDataEntity.fromJson(Map<String, dynamic> json) => AvatarCardDataEntity(
        id: json["id"],
...
class AvatarCardDataAttributesEntity {
    ...
    factory AvatarCardDataAttributesEntity.fromJson(Map<String, dynamic> json) => AvatarCardDataAttributesEntity(
        name: json["name"],
...
class AvatarCardDataAttributeFormatsEntity {
    ...
    factory AvatarCardDataAttributeFormatsEntity.fromJson(Map<String, dynamic> json) => AvatarCardDataAttributeFormatsEntity(
...
class FormatDataEntity {
    ...
    factory FormatDataEntity.fromJson(Map<String, dynamic> json) => FormatDataEntity(
        ext: json["ext"],
        url: json["url"],
        hash: json["hash"],
        mime: json["mime"],
...
class CardPaginationEntity {
    ...
    factory CardPaginationEntity.fromJson(Map<String, dynamic> json) => CardPaginationEntity(
        page: json["page"],
